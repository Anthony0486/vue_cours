...
watch(result, (newValue) => {
  if (newValue > 7) {
    message.value = "Tu as dépassé le nombre mystère";
  } else if (newValue < 7) {
    message.value = "Essaie encore!";
  } else if (newValue === mystere.value) {
    message.value = "Bingo!";
  }
});
</script>
<template>
  ...
  >
  <h1 class="p-8 text-3xl uppercase font-bold md:text-4xl tracking-[0.1em]">Nombre Mystère 🔍</h1>
